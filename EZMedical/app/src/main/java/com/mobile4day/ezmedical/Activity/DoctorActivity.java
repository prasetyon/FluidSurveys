    ...
    class getList extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String s) {
            ...
            try {
                ...
                lvDoctor.setAdapter(listAdapter);
                lvDoctor.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    @Override
                    public void onItemClick(AdapterView<?> parent, View view, int position, long ids) {
                        new OpenDialog(DoctorActivity.this, name.get(position), photo.get(position), location.get(position), id.get(position), email, extras);
                    }
                });
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                URL url = new URL(getString(R.string.get_doctor_url));
