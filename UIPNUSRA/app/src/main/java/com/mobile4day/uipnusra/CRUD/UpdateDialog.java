...
/**
 * Created by prasetyon on 3/15/2017.
 */
...
public class UpdateDialog {
    ...
    public UpdateDialog(Context activity, int from, String id, String name, Bundle extras)
    {
    ...
    private void showDialog()
    {
        if(Integer.valueOf(Build.VERSION.SDK)>20) {
            final AlertDialog dialog = new AlertDialog.Builder(activity)
                    ...
                    .setView(R.layout.dialog_update_task)
                    .setCancelable(true)
                    .create();
            dialog.show();
            ...
            btnSubmit.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    new UpdateTask(activity, from).execute(edName.getText().toString(), id);
                    dialog.dismiss();
                }
            });
        }
            ...
            dialog.setTitle(R.string.update_task);
    ...
    class UpdateTask extends AsyncTask<String, String, String> {
        ...
        public UpdateTask(Context activity, int from) {
            this.activity = activity;
            this.from = from;
        ...
        protected void onPostExecute(String s) {
            ...
            if (s.equals("1"))
                Toast.makeText(activity, "Task sucessfully updated!", Toast.LENGTH_SHORT).show();
            else
            ...
            try {
                ...
                switch (from) {
                    case 0:
                        break;
                    case 1:
                        url = new URL(activity.getString(R.string.url_update_task));
                        break;
                    case 2:
                        url = new URL(activity.getString(R.string.url_update_subtask));
                        break;
                    case 3:
                        url = new URL(activity.getString(R.string.url_update_subsubtask));
                        break;
                    default:
                        break;
