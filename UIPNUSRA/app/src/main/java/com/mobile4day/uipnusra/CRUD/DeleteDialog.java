...
/**
 * Created by prasetyon on 3/12/2017.
 */
...
public class DeleteDialog {
    ...
    public DeleteDialog(Context activity, int from, String id, String name, Bundle extras)
    {
    ...
    private void showDialog()
    {
        if(Integer.valueOf(Build.VERSION.SDK)>20) {
            ...
            String alert = "Are you sure you want to delete " + name + " ?";
            tvAlert.setText(alert);

            btnYes.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    new DeleteTask(activity).execute(id);
                    dialog.dismiss();
                }
            });
    ...
    class DeleteTask extends AsyncTask<String, String, String>{
        ...
        public DeleteTask(Context activity)
        {
            this.activity = activity;
            ...
            try {
                ...
                switch(from)
                {
                    case 0:
                        break;
                    case 1:
                        url = new URL(activity.getString(R.string.url_delete_task));
                        break;
                    case 2:
                        url = new URL(activity.getString(R.string.url_delete_subtask));
                        break;
                    case 3:
                        url = new URL(activity.getString(R.string.url_delete_subsubtask));
                        break;
                    case 4:
                        url = new URL(activity.getString(R.string.url_delete_image));
                        break;
                    default:
                        break;
