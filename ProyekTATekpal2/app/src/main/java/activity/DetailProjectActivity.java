...
public class DetailProjectActivity extends AppCompatActivity {
    ...
    EditText edDaftarNIK1, edDaftarNIK2, edDaftarNIK3, edDaftarNIK4, edSaratKapal, edJenisKapal, edClassKapal;
        ...
        public void onClick(View v) {
            ...
            switch (v.getId()){
                case R.id.btnUpdate:
                    ...
                    new updateData().execute(owner_proyek, nama_proyek, admin, panjang_kapal, lebar_kapal, tinggi_kapal, muatan_kapal, mulai_proyek, selesai_proyek, nik1, nik2, nik3, nik4, sarat, jenis);
                    break;
                case R.id.btnBack:
    ...
    class updateData extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            String create_url = "http://mobile4day.com/welding-inspection/update_project.php";
            try {
                URL url = new URL(create_url);
                HttpURLConnection httpURLConnection = (HttpURLConnection)url.openConnection();
                httpURLConnection.setRequestMethod("POST");
