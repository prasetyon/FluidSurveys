...
public class AdminSignUpActivity extends AppCompatActivity {
    ...
    EditText edUsername, edPassword, edVerPassword, edFullName, edEmail, edPhoneNumber, edActivationCode;
        ...
        btnRegister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(edPassword.getText().toString().equals(edVerPassword.getText().toString()) && edActivationCode.getText().toString().equals(KODE_AKTIVASI)) {
                    ...
                    new BackgroundTask().execute(username, password, name, email, phone);
    ...
    class BackgroundTask extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            String create_url = "http://mobile4day.com/welding-inspection/new_admin.php";
            try {
