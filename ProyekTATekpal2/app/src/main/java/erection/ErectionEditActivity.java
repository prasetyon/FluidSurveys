...
public class ErectionEditActivity extends AppCompatActivity{
        ...
        public void onClick(View v) {
            ...
            switch (v.getId()){
                case R.id.btnSubmit:
                    ...
                    break;
                case R.id.btnBack:
                    intent = new Intent(ErectionEditActivity.this, ErectionListActivity.class);
    ...
    class updateBlock extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String s) {
            ...
            if(created && create.equals("1")){
                Toast.makeText(ErectionEditActivity.this, "You block has been updated!", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(ErectionEditActivity.this, ErectionListActivity.class);
                intent.putExtras(extras);
                startActivity(intent);
                finish();
            }
