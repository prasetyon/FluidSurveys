...
public class SubAssemblyAddActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sub_assembly_add);
        ...
        public void onClick(View v) {
            ...
            switch (v.getId()){
                case R.id.btnSubmit:
                    ...
                    new BackgroundTask().execute(id_proyek, nama_komponen, jenis_komponen, nama_blok);
                    break;
                case R.id.btnBack:
                    intent = new Intent(SubAssemblyAddActivity.this, SubAssemblyActivity.class);
    ...
    class BackgroundTask extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String s) {
            ...
            if (created && create.equals("1")) {
                Toast.makeText(SubAssemblyAddActivity.this, "You component has been created!", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(SubAssemblyAddActivity.this, SubAssemblyListActivity.class);
                intent.putExtras(extras);
                startActivity(intent);
                finish();
            }
        ...
        protected String doInBackground(String... params) {
            ...
            String create_url = "http://mobile4day.com/welding-inspection/new_component.php";
            try {
