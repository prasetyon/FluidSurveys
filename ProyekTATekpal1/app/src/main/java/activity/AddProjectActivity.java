...
public class AddProjectActivity extends AppCompatActivity {
    ...
    EditText edDaftarNIK1, edDaftarNIK2, edDaftarNIK3, edDaftarNIK4, edClassKapal;
        ...
        public void onClick(View v) {
            ...
            switch (v.getId()){
                case R.id.btnUpdate:
                    ...
                    new BackgroundTask().execute(owner_proyek, nama_proyek, admin, panjang_kapal, lebar_kapal, tinggi_kapal, muatan_kapal, mulai_proyek, selesai_proyek, nik1, nik2, nik3, nik4, class_kapal, sarat, jenis);
                    break;
                case R.id.btnBack:
    ...
    class BackgroundTask extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            String class_kapal = params[13];
            String sarat = params[14];
            String jenis = params[15];

            String create_url = "http://mobile4day.com/ship-inspection/new_project.php";
            try {
