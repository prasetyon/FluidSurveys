...
public class RawMaterialDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_raw_material_detail);
        ...
        public void onClick(View v) {
            ...
            switch (v.getId()){
                case R.id.btnUpdate:
                    ...
                    new updateComponent().execute(id_proyek, nama_komponen, jenis_komponen, nama_blok, standard, idKomponen);
                    break;
                case R.id.btnBack:
                    intent = new Intent(RawMaterialDetailActivity.this, RawMaterialListActivity.class);
    ...
    private void setEnable(String from)
    {
        ...
        if(from.equals("edit")){
            ...
            edNamaKomponen.setEnabled(false);
            edNamaBlok.setEnabled(false);
            cbComply.setEnabled(false);
    ...
    private void showProject(String s)
    {
        ...
        try {
            ...
            edProses.setText(jo.getString("proses"));
            edNamaKomponen.setText(jo.getString("nama_komponen"));
            edNamaBlok.setText(jo.getString("nama_blok"));
            if(jo.getString("standard").equals("1")) cbComply.setChecked(true);
            else cbComply.setChecked(false);
    ...
    class updateComponent extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String s) {
            ...
            if (created && create.equals("1")) {
                Toast.makeText(RawMaterialDetailActivity.this, "You component has been updated!", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(RawMaterialDetailActivity.this, RawMaterialListActivity.class);
                intent.putExtras(extras);
                startActivity(intent);
                finish();
            }
        ...
        protected String doInBackground(String... params) {
            ...
            String id_komponen = params[5];

            String create_url = "http://mobile4day.com/ship-inspection/update_component.php";
            try {
                URL url = new URL(create_url);
                HttpURLConnection httpURLConnection = (HttpURLConnection) url.openConnection();
                httpURLConnection.setRequestMethod("POST");
