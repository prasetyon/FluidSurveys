...
public class UserSignUpActivity extends AppCompatActivity {
    ...
    EditText edUsername, edPassword, edVerPassword, edFullName, edEmail, edCompany, edPhoneNumber, edActivationCode, edNIK, edFile;
        ...
        btnRegister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(edPassword.getText().toString().equals(edVerPassword.getText().toString()) && edActivationCode.getText().toString().equals(KODE_AKTIVASI)) {
                    ...
                    new BackgroundTask().execute(username, password, name, department, email, phone, nik, company);
                }
    ...
    class BackgroundTask extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            String create_url = "http://mobile4day.com/ship-inspection/new_user.php";
            try {
    ...
    public void uploadMultipart(String pathName, String name) {
        ...
        filePath = Uri.parse("/storage/emulated/0/Ship Inspection Report/" + pathName);
