...
public class AfterErectionAddActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_after_erection_add);
        ...
        public void onClick(View v) {
            ...
            switch (v.getId()){
                case R.id.btnUpdate:
                    ...
                    break;
                case R.id.btnBack:
                    intent = new Intent(AfterErectionAddActivity.this, AfterErectionActivity.class);
    ...
    class NewBlock extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String s) {
            ...
            if(created && create.equals("1")){
                Toast.makeText(AfterErectionAddActivity.this, "You block has been created!", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(AfterErectionAddActivity.this, AfterErectionListActivity.class);
                intent.putExtras(extras);
                startActivity(intent);
                finish();
            }
