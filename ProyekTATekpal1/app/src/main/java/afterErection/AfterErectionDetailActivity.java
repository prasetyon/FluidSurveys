...
public class AfterErectionDetailActivity extends AppCompatActivity {

    Button btnBack, btnUpdate;
    Spinner spinnerLokasi;
    boolean doubleBackToExitPressedOnce = false;
    EditText edNamaBlok, edArea, edPrimerCoat, edTightCoat, edFinishCoat;
    CheckBox cbSwp1, cbSsps, cbSwp2, cbSwp1ae, cbSwp2ae, cbSsp1stCoat,
            cb1stCoat1stStripe, cbFirstStripeSecondStripe, cbSecondStripeSecondCoat, cbSecondCoatThirdCoat, cbThirdCoatForthCoat, cbForthCoatFifthCoat, cbStandard;
    CheckBox cbPullOff;
    Context Activity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_after_erection_detail);
        ...
        public void onClick(View v) {
            ...
            switch (v.getId()){
                case R.id.btnUpdate:
                    ...
                    break;
                case R.id.btnBack:
                    intent = new Intent(AfterErectionDetailActivity.this, AfterErectionListActivity.class);
    ...
    private void showBlock(String s) {
        ...
        try {
            ...
            if(jo.getString("swp1").equals("bc")) cbSwp1.setVisibility(View.GONE);
            else if(jo.getString("swp1").equals("ae")) cbSwp1.setChecked(true);
            if(jo.getString("sspsp").equals("bc")) cbSsps.setVisibility(View.GONE);
            else if(jo.getString("sspsp").equals("ae")) cbSsps.setChecked(true);
            if(jo.getString("swp2").equals("bc")) cbSwp2.setVisibility(View.GONE);
            else if(jo.getString("swp2").equals("ae")) cbSwp2.setChecked(true);
            if(jo.getString("swp1ae").equals("bc")) cbSwp1ae.setVisibility(View.GONE);
            else if(jo.getString("swp1ae").equals("ae")) cbSwp1ae.setChecked(true);
            if(jo.getString("swp2ae").equals("bc")) cbSwp2ae.setVisibility(View.GONE);
            else if(jo.getString("swp2ae").equals("ae")) cbSwp2ae.setChecked(true);
            if(jo.getString("ssp1c").equals("bc")) cbSsp1stCoat.setVisibility(View.GONE);
            else if(jo.getString("ssp1c").equals("ae")) cbSsp1stCoat.setChecked(true);
            if(jo.getString("standard").equals("1")) cbStandard.setChecked(true);
            else cbStandard.setChecked(false);
            if(jo.getString("1c1sc").equals("bc")) cb1stCoat1stStripe.setVisibility(View.GONE);
            else if(jo.getString("1c1sc").equals("ae")) cb1stCoat1stStripe.setChecked(true);
            if(jo.getString("1sc2sc").equals("bc")) cbFirstStripeSecondStripe.setVisibility(View.GONE);
            else if(jo.getString("1sc2sc").equals("ae")) cbFirstStripeSecondStripe.setChecked(true);
            if(jo.getString("2sc2c").equals("bc")) cbSecondStripeSecondCoat.setVisibility(View.GONE);
            else if(jo.getString("2sc2c").equals("ae")) cbSecondStripeSecondCoat.setChecked(true);
            if(jo.getString("2c3c").equals("bc")) cbSecondCoatThirdCoat.setVisibility(View.GONE);
            else if(jo.getString("2c3c").equals("ae")) cbSecondCoatThirdCoat.setChecked(true);
            if(jo.getString("3c4c").equals("bc")) cbThirdCoatForthCoat.setVisibility(View.GONE);
            else if(jo.getString("3c4c").equals("ae")) cbThirdCoatForthCoat.setChecked(true);
            if(jo.getString("4c5c").equals("bc")) cbForthCoatFifthCoat.setVisibility(View.GONE);
            else if(jo.getString("4c5c").equals("ae")) cbForthCoatFifthCoat.setChecked(true);
            if(jo.getString("pulloff").equals("bc")) cbPullOff.setVisibility(View.GONE);
            else if(jo.getString("pulloff").equals("ae")) cbPullOff.setChecked(true);
    ...
    class updateBlock extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String s) {
            ...
            if(created && create.equals("1")){
                Toast.makeText(AfterErectionDetailActivity.this, "You block has been updated!", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(AfterErectionDetailActivity.this, AfterErectionListActivity.class);
                intent.putExtras(extras);
                startActivity(intent);
                finish();
            }
            else{
                //Toast.makeText(AfterErectionDetailActivity.this, "failed! s= " + s, Toast.LENGTH_SHORT).show();
            }
        }
